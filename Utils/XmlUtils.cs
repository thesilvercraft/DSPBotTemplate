...
namespace DSPBotTemplate.Utils
{
    /// <summary>
    /// taken from silverbot's source at 20:54 29/03/2021 gmt+2
    /// </summary>
    public class XmlUtils
    {
        ...
        public static async Task<string> SerializeToXmlAsync(object input)
        {
            ...
            new XmlSerializer(input.GetType()).Serialize(memStm, input);
            memStm.Position = 0;
            return await new StreamReader(memStm).ReadToEndAsync();
        }
